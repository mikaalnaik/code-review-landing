...
const MainHero = ({ isVariant }: Props) => {
  ...
  const title = isVariant
    ? 'Grow your home maintenaince business'
    : 'Kickstart a new home maintenaince business';
  ...
  const mainBody = isVariant
    ...
    : "It's never been easier to build your own home maintenaince business. Let HomeHero take care of your clients, payroll and scheduling.";
